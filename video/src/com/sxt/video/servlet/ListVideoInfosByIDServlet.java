...
public class ListVideoInfosByIDServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		VideoInfos videoinfo = vis.findByID(Integer.parseInt(videoInfoIDStr));
		request.setAttribute("video", videoinfo);
		
		CommentInfosService cis = new CommentInfosServiceImpl();
		List<CommentInfosVO> list = cis.findByVideoinfoID(Integer.parseInt(videoInfoIDStr));
