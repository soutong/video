	...
	<table width="100%" border="0" cellspacing="0" class="tab">
	  <tr>
	    <td width="188" bgcolor="#F2F7FD"><div class="bbs_left">
	        ...
	        <p>${cvo.userID }</p>
	        <p><img src="images/12.jpeg" height="75" width="200"/></p>
	
	        <ul>
	          <li>姓名：<span>${cvo.studentName }</span></li>
	          <li>性别：<span>
	          <c:if test="${cvo.gender==1 }">男</c:if>
	          <c:if test="${cvo.gender==0 }">女</c:if>
	          </span></li>
	          <li>回复：<span>315</span></li>
	          <li>来自：<span>${cvo.academy }</span></li>
	          <br />
	          <br />
	          <br />
	        </ul>
	   ...
	   <div class="tijiao_kuang">
		...
		<table>
			<tr>
			<td><input type="hidden" name="videoInfoID" value="${video.videoInfoID }"/></td>
			</tr>
                <tr>
                	<td width="80" align="right" valign="top">内容：</td>
               	  <td><textarea name="contents" cols="40" rows="5" class="text"></textarea></td>
                </tr>
                <tr>
